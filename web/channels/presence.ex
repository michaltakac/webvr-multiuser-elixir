defmodule MultiuserElixir.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule MultiuserElixir.MyChannel do
  ...
  """
  use Phoenix.Presence, otp_app: :multiuser_elixir,
                        pubsub_server: MultiuserElixir.PubSub
end
